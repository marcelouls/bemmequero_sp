...
class PsicoModel extends Model
{
    ...
    protected $fillable = [
"motivo_consulta",  "inicio_queixa","mudanca_queixa","sintomas_queixa","sintomas_queixa","tipo_sono", "horas_sono" ,"dif_inicio", "acorda_noite", "acorda_manha", "exceso_sono", "pesadelos", "camina", "tipo_alimentacao", "outro_tipo_alimentacao",
