...
<div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text"  class="form-control @error('cpf') is-invalid @enderror" id="cpf" name="cpf" value="{{$paciente->cpf ?? ""}} {{old('cpf')}}" required>
      @error('cpf')
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
        <input type="text"  class="form-control @error('nome_paciente') is-invalid @enderror" id="nome_paciente" name="nome_paciente" value="{{$paciente->nome_paciente ?? ""}} {{old('nome_paciente')}}" required>
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text"  class="form-control @error('fone') is-invalid @enderror" id="fone" name="fone" value="{{$paciente->fone ?? ""}} {{old('fone')}}" required>
    </div>
  </div>
  <div class="mb-3 row">
    <label for="email" class="col-sm-2 col-form-label">Email :</label>
    <div class="col-sm-10">
        <input type="email"  class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{$paciente->email ?? ""}} {{old('email')}}" required>
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <select class="form-select" name="sexo" id="sexo" " required>
          <option value="{{$paciente->sexo ?? ""}} {{old('sexo')}}>{{$paciente->sexo ?? ""}}</option>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
            ...
            <option value="{{$paciente->estado_civil ?? ""}} {{old('estado_civil')}}">{{$paciente->estado_civil ?? ""}}</option>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="date"  class="form-control" id="data_nasc" name="data_nasc" value="{{$paciente->data_nasc ?? ""}}{{old('data_nasc')}}" required>
    </div>
  </div>
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
        <select class="form-select" name="escolaridade"  required>
            <option value="{{$paciente->escolaridade ?? ""}} {{old('escolaridade')}}">{{$paciente->escolaridade ?? ""}}"</option>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
        <input type="text"  class="form-control" id="ocupacao_principal" name="ocupacao_principal" value="{{$paciente->ocupacao_principal ?? ""}} {{old('ocupacao_principal')}}" required>
    </div>
  </div>
