    ...
    <div class="container">
        ...
        <form action="#" method="post">
            ...
            <div class="row col-md-12 " style=" border: 1px solid black;">
                <h3>Sono</h3>
                <div>
                    <label>Adequado   </label><input type="radio" name="sono" id="adequado" value="1 ">
                    <label>Tranquilo   </label><input type="radio" name="sono" id="tranquilo" value="2 ">
                    <label>Inquieto   </label><input type="radio" name="sono" id="Inquieto" value="3 ">
                </div>
                <div class="row " class="col-md-12 ">
                    <label class="col-md-2 ">Horas dormidas :
                        <input  type="text" class="col=md-10" style="width: 40px; ">
                    </label>
                </div>
            ...
            <div class="row col-md-12 " style="border: 1px solid black ">
                ...
                <div>
                    <label>Adequada   </label><input type="radio" name="esforco " id="adequada " value="1 ">
                    <label>Come bem   </label><input type="radio" name="esforco " id="come_bem " value="2 ">
                    <label>Come mal   </label><input type="radio" name="esforco " id="_come_mal " value="3 ">
                </div>
                ...
                <label>Episódios de descontrole alimentar:
                    <input type="radio" name="descontrole " value="1 "><label>Sim</label>
                <input type="radio" name="descontrole " value="2 "><label>Não</label>
                </label>
                <div>
                    <label>Ingesta vária em situações de tristeza, nervosismo, estresse ou ansiedade: </label>
                    <input type="checkbox" name="ingesta" id="ingesta" value="1 "><br>
                </div>


                <div>
                    <label>Usou medicamentos para baixar de peso: </label>
                    <input type="checkbox" name="ingesta " id="ingesta " value="1 ">
                </div>
                <div>
            ...
            <div class="row col-md-12 " style="border: 1px solid black ">
                <div class="col-md-12 ">
                    ...
                    <label>Manter</label><input type="radio" name="objetivo " id="manter " value="1 ">
                    <label>Ganhar massa muscular</label><input type="radio" name="objetivo " id="ganhar " value="2 ">
                    <label>Perder gordura</label><input type="radio" name="objetivo " id="perder " value="3 "><br>
                    <div class="row col-md-12 ">
                        <label class="col-md-2 ">Outro</label>
                        <input type="text" class="col-md-10 ">
                    </div>
